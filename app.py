...
class InterfazCalculadora:
    ...
    def renderizar(self):
        ...
        # MENÚ DE PESTAÑAS (Modificadas para que operen con variables dinámicas)
        ...
        with tab_calculos:
            ...
            with col_input_izq:
                # Modificado a max_value=12.0 según tu requerimiento exacto
            ...
            # EL BOTÓN EXPLICITO DE CALCULAR SOLICITADO
            btn_calcular = st.button("▶ EJECUTAR CÁLCULO TÉCNICO", type="primary", use_container_width=True)
            
            # Lógica para guardar la última corrida activa
            if btn_calcular:
            ...
            st.markdown("<h2 style='font-size: 24px; font-weight: bold;'>生产 Diagnóstico y Resultados</h2>", unsafe_allow_html=True)

            # Mostrar resultados congelados o procesados mediante el botón
        ...
        # ================= PESTAÑA 2: HISTORIAL (YA FUNCIONA AL 100%) =================
        with tab_historial:
        ...
        # ================= PESTAÑA 3: GRÁFICAS (SIMULACIÓN INDUSTRIAL) =================
        with tab_graficas:
            ...
            # Simulación gráfica simple usando los componentes de Streamlit
        ...
        if st.button("Volver a Portada de Inicio"):
            ...
            # Limpiar la memoria temporal al salir si se desea reiniciar
            if "ultimo_resultado" in st.session_state:
